        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details">
              <h1>{{ $item->title}}</h1> {{-- untuk mengambil title berasal dari DetailController --}}
              <p>
                {{ $item->location }} {{-- untuk mengambil lcoation berasal dari DetailController --}}
              </p>
                ...
                <div class="gallery">
                  <div class="xzoom-container">
                    <img
                      class="xzoom"
                      id="xzoom-default"
                      src="{{ Storage::url($item->galleries->first()->image) }}" {{-- ibarat Buka Storage yang di dalamnya ada url yang mengarah ke DetailController terus ambil $item masukan galleries yang sudah dipanggil di controller dan ambil gambar pertama 'FIRST()' yaitu image. --}}
              ...
              <table class="trip-informations">
                <tr>
                  ...
                  <td width="50%" class="text-right">
                    ...
                    {{-- carbon sudah terinstall otomatis untuk membuat tanggal --}}
                  </td>
                </tr>
                <tr>
