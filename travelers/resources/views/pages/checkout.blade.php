        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details mb-3">
              {{-- UNTUK MEMUNCULKAN ERROR APABILA ADA ERROR --}}
              @if ($errors->any())
                  ...
                  <tbody>
                    ...
                    @forelse ($item->details as $detail)
                      <tr>
                        ...
                        <td class="align-middle">
                          {{ $detail->is_visa ? '30Days' : 'N/A' }}  {{-- Tenery Function untuk mengecek seperti IF Else --}}
                        </td>
                        <td class="align-middle">
              ...
              <div class="member mt-3">
                ...
                <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                  ...
                  <input type="text" class="form-control mb-2 mr-sm-2" id="username" name="username" placeholder="Username" required />

                  <label class="sr-only" for="nationality">Nationality</label>
                  <input type="text" class="form-control mb-2 mr-sm-2" id="nationality" name="nationality" placeholder="Nationality" style="width: 50px;" required />

                  <label class="sr-only" class="mr-2" for="is_visa" >
                    Visa
                  </label>
                  ...
                  <div class="input-group mb-2 mr-sm-2">
                    <input type="text" class="form-control datepicker" id="doePassport" name="doe_passport" placeholder="DOE Passport" style="width: 10vw;" />
                  </div>
              ...
              <table class="trip-informations">
                <tr>
                  ...
                  <td width="50%" class="text-right">
                    {{ $item->details->count()}} {{-- UNTUK MENGIHITUNG DETAIL ADA BERAPA ORANG YANG MAU CHECKOUT TRIP --}}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right text-total">
                    ...
                    ><span class="text-orange">{{ mt_rand(0,99) }}</span> {{-- Untuk membuat kode Unik dibelakang dengan kode dibawah 0,99 --}}
                  </td>
                </tr>
              </table>
...
@push('addon-script')
    ...
    $(document).ready(function() {
        ...
        format: 'yyyy-mm-dd', //untuk mengikuti format tanggal di database
